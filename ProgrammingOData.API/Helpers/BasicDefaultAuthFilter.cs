...
public class BasicDefaultAuthFilter : Attribute, IAsyncAuthorizationFilter
{
    private readonly IUserRepository _userRepository;
    private readonly IConfiguration _configuration;
    private readonly string _hashKey;

    public BasicDefaultAuthFilter(IUserRepository userRepository, IConfiguration configuration)
    {
    ...
    public async Task OnAuthorizationAsync(AuthorizationFilterContext context)
    {
        ...
        if (!Enum.TryParse<UserRole>(existsUser.UserRole, out var _))
        {
            context.Result = new UnauthorizedObjectResult(new
            {
